 ...
 * @param {?any=} trg
 */
define.alias = (src, name, alias, trg) => {
  Fail.assert(alias, '[ define.alias ]: expected alias to be one of [ string, object, function ]')
  ...
  Fail.assert(desc, `[ define.alias ] no such property "${ name }"`)
